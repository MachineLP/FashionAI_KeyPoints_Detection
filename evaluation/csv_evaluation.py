...
def criterion(ann_gt, ann_dt):
	...
	if category in ['blouse','outwear','skirt']: # armpit distance
		thre = euclidean_distance(gt_kpt[5], gt_kpt[6])
	elif category in ['trousers', 'dress']: # waistband distance
...
def main():
	...
	#--------------------------- model -------------------------------------------------------------------------------
	import models.CPM
	pytorch_model = '../FashionAI/Heatmap/experiments/CPM/20000.pth.tar'
